...
export let defProcs = [
...

    {
        ...
        "name": "PROC_EXPO",
        "filename": "proc_expo",
        "description": "Exponential (actual just a 2nd degree function)",
        "types": [
            {
                "name" : "inType",
                "num" : 1,
...

    {
        ...
        "values": [
            ...
            {
                "name": "gearCouplingTime",
                "type": "TimeMs",
                "unit": "ms",
                "description": "The time in milliseconds it takes to engage the gear. Set to 0 for double-clutch."
            },
            {
                "name": "gearDoubleDeclutchTime",
                "type": "TimeMs",
                "unit": "ms",
                "description": "The time between disengaging and engaging used to bring the gear up to speed. Set to 0 for a synchronized gear."
            },
            {
                "name": "fullGears",
