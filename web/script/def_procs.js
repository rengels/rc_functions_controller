...
export let defProcs = [
...

    {
        "id": "Ne",
        "name": "PROC_NEUTRAL",
        "filename": "proc_neutral",
        "description": "Ensures neutral signal at start and enlarges the neutral zone.",
        "types": [
            {
                "name" : "type",
                "num" : 1,
        ...
        "values": [
            {
                "name": "initialMs",
                "type": "TimeMs",
                "description": "The initial delay before outputting a signal."
            },
            {
                "name": "debounceMs",
                "type": "TimeMs",
                "description": "How long the signal has to stay neutral."
            },
            {
                "name": "neutral",
                "type": "uint8_t",
                "unit": "sig",
                "description": "The neutral zone."
            }
        ]
    },
    {
